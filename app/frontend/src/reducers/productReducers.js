...
export const productUpdateQtyReducers = (state = { product: {} }, action) => {
    switch (action.type) {
        case PRODUCT_QTY_UPDATE_REQUEST:
            return { loading: true };
        case PRODUCT_QTY_UPDATE_SUCCESS:
            return { loading: false, success: true, product: action.payload };
        case PRODUCT_QTY_UPDATE_FAIL:
            return { loading: false, error: action.payload };
        case PRODUCT_QTY_UPDATE_RESET:
            return {};
        default:
            return state;
    }
...
export const productTopCategoryReducers = (
    state = { products: [] },
    action,
) => {
    switch (action.type) {
